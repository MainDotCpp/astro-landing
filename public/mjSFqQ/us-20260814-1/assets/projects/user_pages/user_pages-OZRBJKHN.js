...
} from "./chunk-3CXD5NFH.js";
import {
  init_text_area_v1
} from "./chunk-TWAA7YIK.js";
import {
  init_survey_image_option_v1
} from "./chunk-RVGXNBF6.js";
import {
  init_select_box_v2
} from "./chunk-R4YB6JIA.js";
import {
  Fetcher,
  MANUALLY_ABORTED,
  checkoutNonceParams,
  ...
  init_fetcher,
  init_nonce
} from "./chunk-3LNDXVKR.js";
import {
  init_addToCart,
  mountComponent
} from "./chunk-UJRAMJAB.js";
import {
  debounce,
  init_general,
  init_nanostores,
  nanostores_exports
} from "./chunk-PJLRY4XU.js";
import {
  init_checkbox_v1,
  init_radio_v1
...
import {
  init_input_v1
} from "./chunk-OSFEJJZW.js";
import {
  init_cf_utils,
  isWithinCustomerCenterView
} from "./chunk-G7XDV2ZR.js";
import {
  init_modal_v1
} from "./chunk-5NUE6T5P.js";
import {
  CF2Component,
  init_runtime,
  registerComponent,
...
async function submitOrderAsync(body, maxRetries = 3, onBeforeSubmit, onRetryAfter) {
  ...
  for (let i = 0; i < maxRetries; i++) {
    try {
      onBeforeSubmit();
      const nonce = await fetchCheckoutNonce();
      const nonceQuery = new URLSearchParams(checkoutNonceParams(nonce)).toString();
      response = await fetch(getRenderedHref(), {
        credentials: "same-origin",
        method: "post",
        body: [body, nonceQuery].filter(Boolean).join("&"),
        headers: {
...
function setupActionLinkListeners() {
  ...
  $(document).on("click", "a[href^='#download-asset:']", function(evt) {
    evt.preventDefault();
    const id = evt.currentTarget.getAttribute("href").replace("#download-asset:", "");
    window.location.href = `/account/downloads/${id}/file`;
    return false;
  });
  $(document).on("click", "a[href^='#download-inline:']", function(evt) {
    evt.preventDefault();
    const id = evt.currentTarget.getAttribute("href").replace("#download-inline:", "");
    window.open(`/account/downloads/${id}/preview`, "_blank");
    return false;
  });
...
init_lander_styles();
init_sharedModules();
//# sourceMappingURL=user_pages-OZRBJKHN.js.map
